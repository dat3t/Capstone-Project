...
namespace OneVietnam
{
    ...
    public class ApplicationIdentityContext : IDisposable
    {
        ...
        private ApplicationIdentityContext(IMongoCollection<ApplicationUser> users, IMongoCollection<Post> posts,
            IMongoCollection<IdentityRole> roles, IMongoCollection<Country> countries, IMongoCollection<DTL.Tag> tags,
        ...
        public static ApplicationIdentityContext Create()
        {
            ...
            return new ApplicationIdentityContext(users, posts, roles, countries, tags, icons, reports, messages);
        }
        public void Dispose()
        {
        }
